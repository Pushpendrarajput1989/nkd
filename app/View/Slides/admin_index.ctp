			...
			<table class="table table-hover">
				...
				<tr>
					...
					<td class="pull-right">
						...
						<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $slide['Slide']['id']), array('class'=>'btn btn-default btn-sm btn-danger'), sprintf(__('Are you sure you want to delete # %s?', true), $slide['Slide']['id'])); ?>
					</td>
				</tr>
				<?php endforeach; ?>
			</table>
